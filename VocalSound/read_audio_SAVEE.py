# -*- coding: utf-8 -*-
"""
Created on Mon Jun 15 19:28:25 2020
...
label_df = pd.read_csv('data\label_df_SAVEE.csv')
...
#%%
with open('data\\audio_SAVEE_4emo_7.5s.pkl','wb') as f:
    pickle.dump(audio_vectors, f)

label_df_filtered.to_csv('data\label_df_SAVEE_4emo.csv', index=False)  
