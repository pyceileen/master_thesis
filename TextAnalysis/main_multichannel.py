# -*- coding: utf-8 -*-
"""
Created on Sun Apr  5 16:44:49 2020
...
#%%
experiments = ['multichannelCNN_reg']
for i in experiments:
    ...
    for j in range(10):
        ...
        history = model.fit([padded_train_X,padded_train_X,padded_train_X],train_y,
                            validation_data=([padded_val_X,padded_val_X,padded_val_X], val_y),
        ...
        y_pred = saved_model.predict([padded_test_X,padded_test_X,padded_test_X])
