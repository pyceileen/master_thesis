# -*- coding: utf-8 -*-
"""
Created on Tue Sep  1 15:37:34 2020
...
df_all['label'] = split(df_all['label'], 2.3,3.7)
...
for i in range(N_TRAIN):
    ...
    early_stopping = EarlyStopping(patience=5, verbose=True, checkpoint_name="bert_final_categorization")
