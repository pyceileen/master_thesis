# -*- coding: utf-8 -*-
"""
Created on Wed Aug 19 19:41:36 2020
...
for num, indices in enumerate(kf.split(audio_y)):
    ...
    stack_train = np.dstack((ensemble_text_train, ensemble_audio_train))
...
#%% export models for demo
from joblib import dump
dump(audio_logistic, 'models\\audio_logistic.joblib') 
dump(final_logistic, 'models\\final_logistic.joblib')
